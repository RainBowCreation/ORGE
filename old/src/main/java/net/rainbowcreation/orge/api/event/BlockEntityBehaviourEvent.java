package net.rainbowcreation.orge.api.event;
...
public class BlockEntityBehaviourEvent {
    ...
    private OrgeBlockEntity smartBlockEntity;
    private Map<BehaviourType<?>, BlockEntityBehaviour> behaviours;

    public BlockEntityBehaviourEvent(OrgeBlockEntity blockEntity, Map<BehaviourType<?>, BlockEntityBehaviour> behaviours) {
    ...
    public OrgeBlockEntity getBlockEntity() {
