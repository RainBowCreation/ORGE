...
public final class RegionMarshaller {
    ...
    public static Flat flatten(List<ColumnTask> cols) {
        ...
        return new Flat(n, cx, cz, matIx, mass, tIn, vxIn, vyIn, vzIn, pIn, swapReadyIn, eIn);
    }
    ...
    public static List<ColumnResult> slice(char[] matOut, float[] massOut, float[] tOut,
        ...
        for (int c = 0; c < nCols; c++) {
            ...
            out.add(new ColumnResult(mi, ms, tt, vxs, vys, vzs, ps, sr, es));
        }
        return out;
    }
    ...
    public static List<ColumnResult> slice(char[] matOut, float[] massOut, float[] tOut,
        ...
        return slice(matOut, massOut, tOut, vxOut, vyOut, vzOut, pOut, swapReadyOut, new float[total], nCols);
    }

    /** Back-compat overload: swapReady + enthalpy channels zero-filled. Velocity + pressure supplied. */
    public static List<ColumnResult> slice(char[] matOut, float[] massOut, float[] tOut,
                                           float[] vxOut, float[] vyOut, float[] vzOut,
